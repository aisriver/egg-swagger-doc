 ...
 * @param name
 */
const toHump = (name: string) => name.substring(1, name.length).replace(/\\(\w)/g, (_, letter) => letter.toUpperCase());
path_method.operationId = toHump(usePath) + method.toUpperCase();
